...
class GalleryFrontController extends Controller
{
    public function addGalleryAction(Request $request)
    {
        ...
        {
            return $this->render('@Back/GalleryFront/gallery_full.html.twig');
        }else {
        ...
        return $this->render('@Back/GalleryFront/gallery_add.html.twig', ['form' => $form->createView()]);
    }
    ...
    public function showGalleryAction()
    {
        ...
        return $this->render('@Back/GalleryFront/gallery_show.html.twig', ['gallery' => $gallery]);
    }
    ...
    public function editGalleryAction(Request $request, Gallery $gallery)
    {
       ...
       return $this->render('@Back/GalleryFront/gallery_edit.html.twig', array(
           'gallery' => $gallery,
